...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired // 基于构造函数的依赖注入
    public AuthorizationServerConfig(PasswordEncoder passwordEncoder, ClientDetailsService clientDetailsService, TokenStore tokenStore) {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory()
                .withClient("client1") //定义client的id
                .secret(passwordEncoder.encode("123123")) // 定义client的密码
...
//    private TokenStore tokenStore;
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        endpoints.authorizationCodeServices(new InMemoryAuthorizationCodeServices())//授权码管理
