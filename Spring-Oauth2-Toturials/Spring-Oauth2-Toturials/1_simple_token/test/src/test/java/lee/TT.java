...
public class TT {
    ...
    public void getTokenByCode() throws IOException {
        ...
        String[] params = new String[]{
                ...
                "code", "2AuiXv",//这个code是从getCode()方法获取的
    ...
    public void checkToken() throws IOException {
        String[] params = new String[]{
                "token", "2b492d8f-16a7-45c0-bb11-cb71a7b35e34",
        };
    ...
    public void getResourceByToken() throws IOException {
        Map<String, String> head = RootUtil.buildMap("Authorization", "Bearer 40f74e1d-ed0f-4511-8016-c37199df764a");
